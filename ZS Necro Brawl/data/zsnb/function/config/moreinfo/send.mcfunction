...
##Send Info
execute if score #Score zs.game.status matches 4 unless score #Score zs.game.status matches 3 as @a run title @s actionbar ["",{"text":"Points: "},{"score":{"name":"@s","objective":"zsnb.points"}},{"text": " | First To "},{"score":{"name":"#Score","objective":"zsnb.first.to.points"}},{"text":" | Time: "},{"score":{"name":"#MinuteScore","objective":"zs.timer"}},{"text": ":"},{"score":{"name": "#Score","objective": "zs.timer"}},{"text": "."},{"score":{"name": "#MiliScore","objective": "zs.timer"}}]
