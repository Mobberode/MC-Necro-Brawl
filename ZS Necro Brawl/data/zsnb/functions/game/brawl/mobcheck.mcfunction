...
tag @e[type=!minecraft:player,type=!#minecraft:arrows,type=!minecraft:item,type=!area_effect_cloud,type=!text_display,type=!item_display,type=!block_display,type=!interaction,tag=pwait,type=!iron_golem,type=!snow_golem] add mob
